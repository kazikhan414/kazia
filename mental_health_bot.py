    ...
    try:
        ...
        try:
            ...
            if test_response.status_code != 200:
                st.error("Unable to connect to OpenRouter API. Please check your internet connection.")
                return None
        ...
        if response.status_code == 401:
            st.error("API Error: Unauthorized. Please check your API key and try again.")
            return None
